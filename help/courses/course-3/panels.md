...
1. 单击 [!UICONTROL **省略号**] 位于用于访问上下文选项的主题旁边。
...
1. 单击 [!UICONTROL **省略号**] 在主题旁边以显示上下文选项，包括从“收藏夹”列表中将其删除的选项。
...
1. 设置 **文档状态** to **编辑**. 请注意，引用列表当前为空。

   ![无引用](images/lesson-5/no-references.png)

1. 关闭主题。

1. 选择 [!UICONTROL **存储库视图**] 中。
