...
4. 选择所需的配置文件。 例如，选择 **全局配置文件**，这是默认的用户档案。
...
6. 单击 [!UICONTROL **保存**] 中)来访问Advertising Cloud的帮助。
...
2. 在左侧面板中，选中任何非必需预设的复选框。

   ![删除预设](images/lesson-3/delete-presets.png)

3. 单击 [!UICONTROL **删除预设**] 中。

4. 在删除预设对话框中，单击 [!UICONTROL **删除**].
...
2. 在“XML Editor Snippets（XML编辑器代码片段）”下，单击 [!UICONTROL **上传**].
...
3. 单击 [!UICONTROL **用户首选项**] 图标。

   ![用户首选项](images/lesson-3/hr-user-prefs.png)

4. 在用户首选项对话框中，从下拉菜单中选择所需的文件夹配置文件。
